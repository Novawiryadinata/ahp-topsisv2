		...
		<div class="one column row">
			<div class="column">
				<div class="ui fluid card">
					<div class="content">
						<div class="center aligned header" style="font-size:60pt ;">
							HIRARKI DAN ALUR AHP + TOPSIS
						</div>
					</div>
					<div class="content">

						<img src="/assets/AHP.jpg" alt="HTML5 Icon" style="width:'AUTO';height:AUTO; display: block;
  margin-left: auto;
  margin-right: auto;
  width: 100%;">
