...
<body>
<!-- <header style="background:#2E14D9;">
	
</header> -->
<div class="wrapper">
	<nav id="navigation" role="navigation"  style="background:#2E14D9;">
		<ul>
			<li><h1 style="color:#ffffff;">AHP x TOPSIS</h1></li>
			<br>
			<li><a class="item" href="<?= base_url("index.php")?>">Hierarki</a></li>
			<li>
				<a class="item" href="<?= base_url("kriteria.php")?>">Kriteria
					<div class="ui white tiny label  " style="float: right"; back"><?php echo getJumlahKriteria(); ?></div>
				</a>
			</li>
			<li>
				<a class="item" href="<?= base_url("alternatif.php")?>">Alternatif
					<div class="ui white tiny label" style="float: right; color: 0;"><?php echo getJumlahAlternatif(); ?></div>
				</a>
			</li>
			<li>
